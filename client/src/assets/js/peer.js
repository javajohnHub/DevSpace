/*! peerjs_fork_firefox40 build:0.3.15, development. Copyright(c) 2013 Michelle Bu <michelle@michellebu.com> */ (function e(
  t,
  n,
  r
) {
          ...
          if (vp9_codec) {
            res = res.map(function(line) {
              ...
              if (m) {
                ...
                util.log(
                  "Changed codec priority:",
                  "m=video " + m[1] + " " + m[2] + " " + codec_list.join(" ")
                );
                return (
                  "m=video " + m[1] + " " + m[2] + " " + codec_list.join(" ")
                );
